...
/**
 * Uploads draft images to GitHub under the Metalsmith starter's
 * src/assets/images/blog/<slug>/ directory.
 ...
 * @return {Promise<void>}
 */
export async function uploadDraftImages(ui, draft, slug, branchName, getSha) {
